...
const UserUrl = () => {
  ...
  if (!urls.urls || urls.urls.length === 0) {
    return (
      <div className="text-center text-gray-50 my-6 p-4 bg-gray-500 rounded-lg border border-gray-300">
  ...
  return (
    <div className="bg-[#0d1b2a] rounded-lg mt-5 shadow-lg overflow-hidden text-[#e0e1dd]">

  <div className="overflow-x-auto h-56">
    <table className="min-w-full divide-y divide-[#415a77]">
      <thead className="bg-[#1b263b]">
        <tr>
          <th className="px-6 py-3 text-left text-xs font-semibold text-[#e0e1dd] uppercase tracking-wider">
            Original URL
          </th>
          <th className="px-6 py-3 text-left text-xs font-semibold text-[#e0e1dd] uppercase tracking-wider">
            Short URL
      ...
      <tbody className="bg-[#0d1b2a] divide-y divide-[#415a77]">
        {urls.urls.reverse().map((url) => (
          <tr key={url._id} className="hover:bg-[#1b263b] transition-colors duration-200">
            <td className="px-6 py-4">
              <div className="text-sm text-[#e0e1dd] truncate max-w-xs">
                {url.full_url}
              </div>
            </td>
            <td className="px-6 py-4">
            ...
            <td className="px-6 py-4">
              <div className="text-sm">
                <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-[#415a77] text-white">
